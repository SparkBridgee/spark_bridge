...
import { Check, Eye, Heart, MessageCircle, Share2, Repeat2 } from "lucide-react";
          ...
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-[10px] font-semibold text-white sm:text-xs">
            ...
            {video.platform === "instagram" ? (
              <span
                ...
                title="스토리 reshare + 프로필 repost + DM 공유 합산값"
              >
                <Share2 className="h-3 w-3 sm:h-3.5 sm:w-3.5" />
                <Repeat2 className="h-3 w-3 opacity-70 sm:h-3.5 sm:w-3.5" />
